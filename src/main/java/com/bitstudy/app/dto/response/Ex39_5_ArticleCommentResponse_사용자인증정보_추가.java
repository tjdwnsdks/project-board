...
public record Ex39_5_ArticleCommentResponse_사용자인증정보_추가(
        Long id,
        String content,
    ...
    public static Ex39_5_ArticleCommentResponse_사용자인증정보_추가 of(Long id, String content, LocalDateTime createdAt, String email, String nickname, /**/String userId/**/) {
        /*추가*/  return new Ex39_5_ArticleCommentResponse_사용자인증정보_추가(id, content, createdAt, email, nickname, /**/userId/**/);
    }

    public static Ex39_5_ArticleCommentResponse_사용자인증정보_추가 from(ArticleCommentDto dto) { /* ArticleCommentDto 을 받아서*/
        ...
        return new Ex39_5_ArticleCommentResponse_사용자인증정보_추가(
                dto.id(),
                dto.content(),
                dto.createdAt(),
