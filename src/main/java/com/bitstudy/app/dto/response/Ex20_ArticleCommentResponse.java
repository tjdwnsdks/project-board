...
public record Ex20_ArticleCommentResponse(
        Long id,
        String content,
    ...
    public static Ex20_ArticleCommentResponse of(Long id, String content, LocalDateTime createdAt, String email, String nickname) {
        return new Ex20_ArticleCommentResponse(id, content, createdAt, email, nickname);
    }

    public static Ex20_ArticleCommentResponse from(ArticleCommentDto dto) { /* ArticleCommentDto 을 받아서*/
        ...
        return new Ex20_ArticleCommentResponse(
                dto.id(),
                dto.content(),
                dto.createdAt(),
