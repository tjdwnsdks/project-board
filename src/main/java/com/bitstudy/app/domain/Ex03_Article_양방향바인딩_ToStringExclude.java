...
//    }
    ...
    * */
    ...
    public static Ex03_Article_양방향바인딩_ToStringExclude of(String title, String content, String hashtag) {
        return new Ex03_Article_양방향바인딩_ToStringExclude(title, content, hashtag);
    }
    ...
    public boolean equals(Object o) { // 동등성 비교
        ...
        Ex03_Article_양방향바인딩_ToStringExclude article = (Ex03_Article_양방향바인딩_ToStringExclude) o;
